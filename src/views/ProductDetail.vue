        ...
        <div class="col-md-7">
          <div class="card shadow-sm">
            <div class="card-body">
              ...
              <h5 class="card-title pt-3">{{getCurrencyFormat(productDetail.product_price)}}원</h5>
              <p class="card-text border-top pt-3 pb-3 border-top">
              ...
              <p class="card-text pb-3">
                배송비 {{getCurrencyFormat(productDetail.delivery_price)}}원 | 도서산관(제주도) 배송비 추가 {{getCurrencyFormat(productDetail.add_delivery_price)}}원 | 택배배송 | {{productDetail.outbound_days}}일 이내 출고 (주말, 공휴일 제외)
              </p>
...
export default {
  ...
  created () {
    this.productId = this.$router.query.product_id
